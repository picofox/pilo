...
namespace pilo
{
    namespace core
    {
        namespace memory
        {
            ...
            class compactable_overlapped_memory_pool
                : public overlapped_memory_pool<_UnitSize, _Step, _Lock>
            {
            public:
                typedef _Lock                                              lock_type;
                typedef overlapped_memory_pool<_UnitSize, _Step, _Lock>    base_type;

...
#           endif
            ...
            pilo::i32_t fs_util::lock_file(os_file_descriptor_t fildes, bool is_exclusive, size_t start_pos, size_t size_to_lock)
            {
#           ifdef  WINDOWS
                DWORD flag = 0;
                if (is_exclusive)
...
#           endif
            ...
            pilo::i32_t fs_util::try_lock_file(os_file_descriptor_t fildes, bool is_exclusive, size_t start_pos, size_t size_to_lock)
            {
#           ifdef  WINDOWS
                DWORD flag = 0;
                if (is_exclusive)
...
#           endif
            ...
            pilo::i32_t fs_util::unlock_file(os_file_descriptor_t fildes, size_t start_pos, size_t size_to_lock)
            {
#           ifdef  WINDOWS
                OVERLAPPED overlapvar = { 0 };
                LARGE_INTEGER li_size;

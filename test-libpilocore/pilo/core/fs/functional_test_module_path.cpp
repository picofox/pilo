...
namespace pilo
{
    namespace test
    {
        ...
        pilo::i32_t functional_test_dyn(void* param)
        {
            ...
            ::pilo::core::fs::path_string<0> path_fatal_test;
            ...
            ::pilo::core::fs::path_string<0> path_abs_test;
        ...
        pilo::i32_t functional_test_fix(void* param)
        {
            ...
            //check fatal invalid paths
            ::pilo::core::fs::path_string<128> path_fatal_test;
            for (int i = 0; i < (int) (sizeof(__st_c_test_inv_paths) / sizeof(char*)); i++)
            {
                path_fatal_test.reset();
                path_fatal_test.assign_path_string(__st_c_test_inv_paths[i]);
            ...
            ::pilo::core::fs::path_string<128> path_abs_test;
            for (int i = 0; i < (int) (sizeof(__st_c_test_abs_paths) / sizeof(char*)); i++)
            {
                path_abs_test.reset();
                path_abs_test.assign_path_string(__st_c_test_abs_paths[i]);

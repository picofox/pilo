...
#include "functional_test_module_class_compactable_memory_pool.hpp"
#include <algorithm>
...
namespace pilo
{
    namespace test
    {
        static pilo::i32_t functional_compactable_memory_pool_basic(void* param);
        //static pilo::i32_t functional_compactable_memory_pool_mt(void* param);


        pilo::test::testing_case g_functional_cases_compactable_memory_pool[] =
        {
            /*---"----------------------------------------------"*/
            { 1, "Basic Functions of memory pool                ", nullptr, functional_compactable_memory_pool_basic, 0, -1, (pilo::u32_t) - 1 },
        ...
        pilo::i32_t functional_compactable_memory_pool_basic(void* param)
        {
            M_UNUSED(param);
            ...
            pilo::core::memory::compactable_memory_pool<sizeof(test::testing_pod_info), TEST_UNIT_STEP> pool;

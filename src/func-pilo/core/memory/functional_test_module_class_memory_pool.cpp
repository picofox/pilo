...
#include "functional_test_module_class_memory_pool.hpp"
#include <algorithm>
...
namespace pilo
{
    namespace test
    {
        static pilo::i32_t functional_memory_pool_basic(void* param);
        static pilo::i32_t functional_memory_pool_mt(void* param);


        pilo::test::testing_case g_functional_cases_memory_pool[] =
        {
            /*---"----------------------------------------------"*/
            { 1, "Basic Functions of memory pool                ", nullptr, functional_memory_pool_basic, 0, -1, (pilo::u32_t) - 1 },
            { 2, "Basic Functions of MT memory pool             ", nullptr, functional_memory_pool_mt,    0, -1, (pilo::u32_t) - 1 },

#include "nonrecursive_mutex.hpp"
#include "core/threading/atomic.hpp"


#   ifdef WINDOWS

pilo::core::threading::nonrecursive_mutex::nonrecursive_mutex()
{
    _m_active_count = 0;
    _m_event = 0;
}
...
bool pilo::core::threading::nonrecursive_mutex::try_lock()
{
    return (_interlockedbittestandset(&_m_active_count, lock_flag_bit) == 0);
}

void pilo::core::threading::nonrecursive_mutex::lock()
{
...
void pilo::core::threading::nonrecursive_mutex::unlock()
{
...
void* pilo::core::threading::nonrecursive_mutex::get_event()
{

#ifndef _pilo_core_rtti_meta_srcfile_hpp_
#define _pilo_core_rtti_meta_srcfile_hpp_
...
namespace pilo
{
	namespace core
	{
		namespace rtti
		{
			...
			{
			public:
				meta_srcfile(const std::string& namestr)
					: meta_src_node(meta_node_type_enum::ns), _m_name(namestr)
...
#endif // !_pilo_core_rtti_meta_srcfile_hpp_

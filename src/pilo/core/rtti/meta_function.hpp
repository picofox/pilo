...
namespace pilo
{
    namespace core
    {
        namespace rtti
        {
            ...
            {
            public:
                meta_function(::pilo::i16_t indent, ::pilo::u16_t modifiers, ::pilo::u8_t accpriv, meta_func_type func_ype, const std::string& name, const std::string ret_type)
                    :meta_src_node(meta_node_type_enum::var, indent)
                ...
                ::pilo::err_t add_bodyline(::pilo::i16_t rel_indent, ::pilo::u16_t modifiers, const std::string & line, const std::string cmt = "");

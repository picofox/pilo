...
namespace pilo
{
    namespace core
    {
        namespace rtti
        {
            ...
            {
            public:
                meta_variable(::pilo::i16_t indent, ::pilo::u16_t modifiers, ::pilo::u8_t accpriv, ::pilo::u8_t accessor_flag, const std::string& namestr, const std::string& typestr, const std::string& valuestr)
